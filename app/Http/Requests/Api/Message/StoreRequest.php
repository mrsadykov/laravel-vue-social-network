...
class StoreRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'chat_id' => [ 'required', 'integer', 'exists:posts,id' ],
    ...
    public function messages(): array
    {
        return [
            ...
            'chat_id.required' => 'Поле обязательное для заполнения',
            'chat_id.integer' => 'Поле должно быть числовым',
            'chat_id.exists' => 'Статьи не существует',
